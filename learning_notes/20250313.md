...
## Java의 정의
* Java는 oracle에서 관리하는 객체지향 프로그래밍 언어(OOP : Object-Orineted Programming Language)
...
## IntelliJ 소개
: 이클립스처럼 Java IDE(Intergrated Development Environment: 퉁합 개발 환경)
...
: 관리 용이
: 패키지는 실제로 디렉토리 형태로 저장되는데, Java 코드낙 담겨있다면 패키지라고 칭하는 편
: 패키지는 소문자로 작성
